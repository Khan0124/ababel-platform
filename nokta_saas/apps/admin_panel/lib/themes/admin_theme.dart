...
class AdminTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      hintStyle: const TextStyle(color: textLight, fontFamily: 'Cairo'),
    ),

    // Navigation Rail Theme (for admin panel)
    navigationRailTheme: NavigationRailThemeData(
      backgroundColor: lightIndigo,
      selectedIconTheme: const IconThemeData(color: primaryIndigo, size: 24),
  ...
  // Plan colors
  static const Color basicPlan = Colors.grey;
