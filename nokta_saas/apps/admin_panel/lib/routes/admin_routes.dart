...
class AdminRoutes {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case tenants:
        return MaterialPageRoute(builder: (_) => const TenantsManagementScreen());
      case products:
        return MaterialPageRoute(builder: (_) => const ProductsManagementScreen());
      case users:
      ...
      case billing:
        return MaterialPageRoute(builder: (_) => const BillingManagementScreen());
      case support:
