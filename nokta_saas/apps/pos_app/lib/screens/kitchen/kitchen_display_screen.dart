...
class _KitchenDisplayScreenState extends ConsumerState<KitchenDisplayScreen> 
                          ...
                          ? AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                return Opacity(
                                  ...
                                  child: _buildOrderCard(order, status, isUrgent),
                                );
                              },
                            )
  ...
  Widget _buildOrderCard(Order order, OrderStatus currentStatus, bool isUrgent) {
  ...
  String _getOrderTime(Order order) {
    ...
    final orderTime = order.confirmedAt ?? order.createdAt;
  ...
  void _startPreparing(Order order) async {
    final success = await ref.read(orderServiceProvider).updateOrderStatus(
      order.id,
