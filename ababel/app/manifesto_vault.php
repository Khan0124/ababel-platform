...
// حساب رصيد خزنة المنفستو
$sum_in = $conn->query("SELECT SUM(amount) as total FROM cashbox WHERE type = 'قبض' AND source = 'منفستو'")->fetch_assoc()['total'] ?? 0;
...
<div class="container">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-0"><i class="fas fa-ship me-3"></i> خزنة المنفستو</h1>
                <p class="mb-0 opacity-75">إدارة عمليات قبض عمولات الشحن</p>
            </div>
