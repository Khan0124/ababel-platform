...
class Loading extends Model
{
    ...
    public function create($data)
    {
        ...
        $columnMapping = [
            ...
            'loading_number' => $data['loading_no'], // Alternative column name
    ...
    public function update($id, $data)
    {
        ...
        $allowedFields = [
            'shipping_date', 'loading_no', 'loading_number', 'container_no', 'client_id', 
    ...
    public function getFiltered($filters = [])
    {
        ...
        if (!empty($filters['loading_no'])) {
            $sql .= " AND (l.loading_no LIKE ? OR l.loading_number LIKE ?)";
