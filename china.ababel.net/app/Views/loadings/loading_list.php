                            ...
                            <td class="no-print">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button class="btn btn-success" 
                                            ...
                                            <?= $loading['status'] != 'shipped' ? 'disabled' : '' ?>>
...
function exportToExcel() {
    // Create a copy of the table without action column
    const table = document.getElementById('loadings-table').cloneNode(true);
    ...
    const wb = XLSX.utils.table_to_book(table, { sheet: "Loadings" });
    XLSX.writeFile(wb, `loadings_${new Date().toISOString().slice(0, 10)}.xlsx`);
}
</script>
