                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="payment_method" name="payment_method" required>
                                    ...
                                    <?php foreach ($paymentMethods as $key => $method): ?>
                                        <option value="<?= $key ?>" <?= $loading['payment_method'] == $key ? 'selected' : '' ?>>
                                            <?= $method ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" 
                                       ...
                                       readonly>
                                <input type="hidden" id="client_id" name="client_id" value="<?= $loading['client_id'] ?>">
...
// Show client info on load
const currentClientCode = document.getElementById('client_code').value;
if (currentClientCode) {
    document.getElementById('client_code').dispatchEvent(new Event('input'));
}
</script>
