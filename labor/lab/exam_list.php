        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (selectedStatus === 'تم التسليم' || selectedStatus === 'تم الاستخراج') {
                        enterResultCell.innerHTML = '-';
                    } else {
                        enterResultCell.innerHTML = `<a href="enter_exam_result.php?exam_id=${examId}" class="btn btn-sm btn-success">إدخال النتيجة</a>`;
                    }
                } else {
