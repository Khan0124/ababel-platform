...
// Calculate balance
$sum_in = $conn->query("SELECT SUM(amount) as total FROM cashbox WHERE type = 'قبض' AND source = 'تختيم'")->fetch_assoc()['total'] ?? 0;
...
<div class="container">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-0"><i class="fas fa-stamp me-3"></i> خزنة التختيم</h1>
                <p class="mb-0 opacity-75">إدارة عمليات القبض والصرف المتعلقة بالتختيم</p>
            </div>
